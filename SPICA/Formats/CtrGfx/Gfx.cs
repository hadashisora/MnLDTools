...
namespace SPICA.Formats.CtrGfx
{
    ...
    public class Gfx
    {
        ...
        //The thing below is a failed attempt at H3D->CGFX conversion...RIP code and thx VS for using individual line comments for commenting out this whole block
        //public Gfx(H3D H3DScene)
        //{
        //    Models = new GfxDict<GfxModel>();
        //    Textures = new GfxDict<GfxTexture>();
        //    LUTs = new GfxDict<GfxLUT>();
        ...
        //    foreach (H3DModel Model in H3DScene.Models)
        //    {
        //        GfxModel Mdl = new GfxModel();
        ...
        //        {
        //            GfxMaterial Mat = new GfxMaterial() { Name = Material.Name };

        //            //Mat.MaterialParams.ModelReference = $"{Mat.Name}@{Model.Name}";
        //            //Mat.MaterialParams.ShaderReference = "0@DefaultShader";

        //            Mat.Flags = (GfxMaterialFlags)Material.MaterialParams.Flags;

        //            Mat.TranslucencyKind = (GfxTranslucencyKind)Material.MaterialParams.TranslucencyKind;
        //            Mat.TexCoordConfig = (GfxTexCoordConfig)Material.MaterialParams.TexCoordConfig;

        //            Mat.Colors.Emission = Material.MaterialParams.EmissionColor;
        //            Mat.Colors.Ambient = Material.MaterialParams.AmbientColor;
        //            Mat.Colors.Diffuse = Material.MaterialParams.DiffuseColor;
        //            Mat.Colors.Specular0 = Material.MaterialParams.Specular0Color;
        //            Mat.Colors.Specular1 = Material.MaterialParams.Specular1Color;
        //            Mat.Colors.Constant0 = Material.MaterialParams.Constant0Color;
        //            Mat.Colors.Constant1 = Material.MaterialParams.Constant1Color;
        //            Mat.Colors.Constant2 = Material.MaterialParams.Constant2Color;
        //            Mat.Colors.Constant3 = Material.MaterialParams.Constant3Color;
        //            Mat.Colors.Constant4 = Material.MaterialParams.Constant4Color;
        //            Mat.Colors.Constant5 = Material.MaterialParams.Constant5Color;
        //            Mat.Colors.Scale = Material.MaterialParams.ColorScale;

        //            if (Material.MaterialParams.Flags.HasFlag(H3DMaterialFlags.IsPolygonOffsetEnabled))
        //            {
        //                Mat.Rasterization.IsPolygonOffsetEnabled = true;
        //            }

        //            Mat.Rasterization.FaceCulling = Material.MaterialParams.FaceCulling.ToGfxFaceCulling();
        //            Mat.Rasterization.PolygonOffsetUnit = Material.MaterialParams.PolygonOffsetUnit;

        //            Mat.FragmentOperation.Depth.ColorMask = Material.MaterialParams.DepthColorMask;
        ...
        //            Mat.FragmentOperation.Blend.ColorOperation = Material.MaterialParams.ColorOperation;
        //            Mat.FragmentOperation.Blend.LogicalOperation = Material.MaterialParams.LogicalOperation;
        //            Mat.FragmentOperation.Blend.Function = Material.MaterialParams.BlendFunction;
        //            Mat.FragmentOperation.Blend.Color = Material.MaterialParams.BlendColor;

        //            Mat.FragmentOperation.Stencil.Operation = Material.MaterialParams.StencilOperation;
        //            Mat.FragmentOperation.Stencil.Test = Material.MaterialParams.StencilTest;

        //            int TCIndex = 0;

        //            foreach (H3DTextureCoord TexCoord in Material.MaterialParams.TextureCoords)
        //            {
        //                GfxTextureCoord TC = new GfxTextureCoord();

        //                TC.MappingType = (GfxTextureMappingType)TexCoord.MappingType;

        //                TC.ReferenceCameraIndex = TexCoord.ReferenceCameraIndex;

        //                TC.TransformType = (GfxTextureTransformType)TexCoord.TransformType;
        ...
        //                {
        //                    case H3DTextureMappingType.UvCoordinateMap:
        //                        TC.SourceCoordIndex = (int)Material.MaterialParams.TextureSources[TCIndex];
        //                        //Mat.MaterialParams.TextureSources[TCIndex] = TexCoord.SourceCoordIndex;
        //                        break;

        //                    case H3DTextureMappingType.CameraCubeEnvMap:
        //                        TC.SourceCoordIndex = 3;
        //                        //Mat.MaterialParams.TextureSources[TCIndex] = 3;
        //                        break;

        //                    case H3DTextureMappingType.CameraSphereEnvMap:
        //                        TC.SourceCoordIndex = 4;
        //                        //Mat.MaterialParams.TextureSources[TCIndex] = 4;
        //                        break;
        //                }

        //                //Mat.MaterialParams.TextureCoords[TCIndex++] = TC;
        //                Mat.TextureCoords[TCIndex++] = TC;

        //                //if (TCIndex == Material.MaterialParams.TextureCoords.Length) break;
        //            }

        //            int TMIndex = 0;

        //            foreach (H3DTextureMapper TexMapper in Material.TextureMappers)
        //            {
        //                //if (TexMapper == null) break; //IDK if this works lol

        //                GfxTextureMapper TM = new GfxTextureMapper();
                        
        //                TM.WrapU = TexMapper.WrapU;
        //                TM.WrapV = TexMapper.WrapV;

        //                //Everuthing below should be broken and not work properly lol
        //                TM.MinFilter = (PICATextureFilter)TexMapper.MagFilter;

        //                switch ((uint)TexMapper.MagFilter | ((uint)TexMapper.MinFilter << 1)) //This is probably also wrong but who knows lol
        //                {
        //                    case 0: TM.MinFilter = (PICATextureFilter)GfxTextureMinFilter.NearestMipmapNearest; break;
        //                    case 1: TM.MinFilter = (PICATextureFilter)GfxTextureMinFilter.LinearMipmapNearest; break;
        //                    case 2: TM.MinFilter = (PICATextureFilter)GfxTextureMinFilter.NearestMipmapLinear; break;
        //                    case 3: TM.MinFilter = (PICATextureFilter)GfxTextureMinFilter.LinearMipmapLinear; break;
        //                    default: Console.WriteLine("Oh no!!! You've messed it up!"); break;
        //                }
        ...
        //            if (Mat.TextureMappers[0] != null) Mat.TextureMappers[0].Texture.Path = Material.Texture0Name;
        //            if (Mat.TextureMappers[1] != null) Mat.TextureMappers[1].Texture.Path = Material.Texture1Name;
        //            if (Mat.TextureMappers[2] != null) Mat.TextureMappers[2].Texture.Path = Material.Texture2Name;

        //            H3DFragmentFlags SrcFlags = Material.MaterialParams.FragmentFlags;
        //            GfxFragmentFlags DstFlags = 0;

        //            if ((SrcFlags & H3DFragmentFlags.IsClampHighLightEnabled) != 0)
        //                DstFlags |= GfxFragmentFlags.IsClampHighLightEnabled;

        //            if ((SrcFlags & H3DFragmentFlags.IsLUTDist0Enabled) != 0)
        //                DstFlags |= GfxFragmentFlags.IsLUTDist0Enabled;

        //            if ((SrcFlags & H3DFragmentFlags.IsLUTDist1Enabled) != 0)
        //                DstFlags |= GfxFragmentFlags.IsLUTDist1Enabled;

        //            if ((SrcFlags & H3DFragmentFlags.IsLUTGeoFactor0Enabled) != 0)
        //                DstFlags |= GfxFragmentFlags.IsLUTGeoFactor0Enabled;

        //            if ((SrcFlags & H3DFragmentFlags.IsLUTGeoFactor1Enabled) != 0)
        //                DstFlags |= GfxFragmentFlags.IsLUTGeoFactor1Enabled;

        //            if ((SrcFlags & H3DFragmentFlags.IsLUTReflectionEnabled) != 0)
        //                DstFlags |= GfxFragmentFlags.IsLUTReflectionEnabled;

        //            if (Material.MaterialParams.FragmentFlags.HasFlag(H3DFragmentFlags.IsBumpRenormalizeEnabled))
        //                Mat.FragmentShader.Lighting.IsBumpRenormalize = true;

        //            Mat.FragmentShader.Lighting.Flags = DstFlags;

        //            Mat.FragmentShader.Lighting.FresnelSelector = (GfxFresnelSelector)Material.MaterialParams.FresnelSelector;

        //            Mat.FragmentShader.Lighting.BumpTexture = Material.MaterialParams.BumpTexture;

        //            Mat.FragmentShader.Lighting.BumpMode = (GfxBumpMode)Material.MaterialParams.BumpMode;

        //            Mat.FragmentShader.LUTs.ReflecR.Input = Material.MaterialParams.LUTInputSelection.ReflecR;
        //            Mat.FragmentShader.LUTs.ReflecG.Input = Material.MaterialParams.LUTInputSelection.ReflecG;
        //            Mat.FragmentShader.LUTs.ReflecB.Input = Material.MaterialParams.LUTInputSelection.ReflecB;
        //            Mat.FragmentShader.LUTs.Dist0.Input = Material.MaterialParams.LUTInputSelection.Dist0;
        //            Mat.FragmentShader.LUTs.Dist1.Input = Material.MaterialParams.LUTInputSelection.Dist1;
        //            Mat.FragmentShader.LUTs.Fresnel.Input = Material.MaterialParams.LUTInputSelection.Fresnel;

        //            Mat.FragmentShader.LUTs.ReflecR.Scale = Material.MaterialParams.LUTInputScale.ReflecR;
        //            Mat.FragmentShader.LUTs.ReflecG.Scale = Material.MaterialParams.LUTInputScale.ReflecG;
        //            Mat.FragmentShader.LUTs.ReflecB.Scale = Material.MaterialParams.LUTInputScale.ReflecB;
        //            Mat.FragmentShader.LUTs.Dist0.Scale = Material.MaterialParams.LUTInputScale.Dist0;
        //            Mat.FragmentShader.LUTs.Dist1.Scale = Material.MaterialParams.LUTInputScale.Dist1;
        //            Mat.FragmentShader.LUTs.Fresnel.Scale = Material.MaterialParams.LUTInputScale.Fresnel;

        //            Mat.FragmentShader.LUTs.ReflecR.Sampler.TableName = Material.MaterialParams.LUTReflecRTableName;
        //            Mat.FragmentShader.LUTs.ReflecG.Sampler.TableName = Material.MaterialParams.LUTReflecGTableName;
        //            Mat.FragmentShader.LUTs.ReflecB.Sampler.TableName = Material.MaterialParams.LUTReflecBTableName;
        //            Mat.FragmentShader.LUTs.Dist0.Sampler.TableName = Material.MaterialParams.LUTDist0TableName;
        //            Mat.FragmentShader.LUTs.Dist1.Sampler.TableName = Material.MaterialParams.LUTDist1TableName;
        //            Mat.FragmentShader.LUTs.Fresnel.Sampler.TableName = Material.MaterialParams.LUTFresnelTableName;

        //            Mat.FragmentShader.LUTs.ReflecR.Sampler.SamplerName = Material.MaterialParams.LUTReflecRSamplerName;
        //            Mat.FragmentShader.LUTs.ReflecG.Sampler.SamplerName = Material.MaterialParams.LUTReflecGSamplerName;
        //            Mat.FragmentShader.LUTs.ReflecB.Sampler.SamplerName = Material.MaterialParams.LUTReflecBSamplerName;
        //            Mat.FragmentShader.LUTs.Dist0.Sampler.SamplerName = Material.MaterialParams.LUTDist0SamplerName;
        //            Mat.FragmentShader.LUTs.Dist1.Sampler.SamplerName = Material.MaterialParams.LUTDist1SamplerName;
        //            Mat.FragmentShader.LUTs.Fresnel.Sampler.SamplerName = Material.MaterialParams.LUTFresnelSamplerName;

        //            Mat.FragmentShader.TextureEnvironments[0] = new GfxTexEnv(Material.MaterialParams.TexEnvStages[0]);
        //            Mat.FragmentShader.TextureEnvironments[1] = new GfxTexEnv(Material.MaterialParams.TexEnvStages[1]);
        //            Mat.FragmentShader.TextureEnvironments[2] = new GfxTexEnv(Material.MaterialParams.TexEnvStages[2]);
        //            Mat.FragmentShader.TextureEnvironments[3] = new GfxTexEnv(Material.MaterialParams.TexEnvStages[3]);
        //            Mat.FragmentShader.TextureEnvironments[4] = new GfxTexEnv(Material.MaterialParams.TexEnvStages[4]);
        //            Mat.FragmentShader.TextureEnvironments[5] = new GfxTexEnv(Material.MaterialParams.TexEnvStages[5]);

        //            Mat.FragmentShader.AlphaTest.Test = Material.MaterialParams.AlphaTest;

        //            Mat.FragmentShader.TexEnvBufferColor = Material.MaterialParams.TexEnvBufferColor;
